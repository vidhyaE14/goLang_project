...
func initializeMigration() {
	...
	// }
	dsn := fmt.Sprintf("admin:%s@tcp(%s)/inventorysystem?charset=utf8mb4&parseTime=True&loc=Local","ywOO73jpZd","mysql-rds-1.c5eooawm67do.us-east-1.rds.amazonaws.com:3306")
